...
const HackathonsPage = () => {
  const { data: ongoing, loading, error } = useFetch('/event/category/Hackathon/ongoing');
  const {data: upcoming ,loading: upcomingLoading, error: upcomingError} = useFetch('/event/category/Hackathon/upcoming');
